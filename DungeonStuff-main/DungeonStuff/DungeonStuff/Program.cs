...
namespace DungeonStuff
{
    class Program
    {
        ...
        public static int characterTurn = 0;
        // 0 % bers ( main character )
        // 1 % mage
        ...
        */ 
            ...
            */
            ...
            Character BOSS = new Character("Amirdrassil", 200, 40, 20, dice);  // Nova Super
                                                                                  // Enemy.Attak(Berserk);
                ...
                switch (CombatMob)
                {
                    ...
                    case 2: // BOSS
                        ...
                        do
                        {
                            ...
                            Character.AlliesOutput(allies);
                            Character.EnemyOutput(boss);

                            Backpack.BackpackDrawFight();

                            characterTurn = ( characterTurn + 1 ) % 4;

                            if (!BOSS.Alive())
                            {
                                Keepfighting = false; // exits fight
                                BackToMap = true;
                            }
